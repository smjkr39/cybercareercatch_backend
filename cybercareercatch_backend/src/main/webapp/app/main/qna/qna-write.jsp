...
<body>
	...
	<div id="qnaWritePage" data-login-required="${loginRequired}"
		...
		<div class="qnw-wrap">
			<div class="qnw-top">
				...
				<a href="${pageContext.request.contextPath}/qna/list.qfc"
					class="qnw-top-mv">기업QnA페이지 바로가기</a>
			</div>

			<div class="qnw-pnl">
				<form id="qnaWriteForm"
					action="${pageContext.request.contextPath}/qna/write.qfc"
					method="post" class="qnw-frm">

					<input type="hidden" name="userNumber"
						value="${requestScope.userNumber}" />

					<div class="qnw-row">
						<div class="qnw-row-col">
							<label for="companyNumber" class="qnw-lbl">기업 선택</label> <select
								name="companyNumber" id="companyNumber" class="qnw-sel" required>
					...
					<div class="qnw-row">
						<div class="qnw-row-col">
							<label for="postTitle" class="qnw-lbl">제목</label> <input
								type="text" name="postTitle" id="postTitle" class="qnw-inp"
								maxlength="100" placeholder="제목은 10자 이상 100자 이하로 입력해주세요"
								required />
						</div>
					</div>
					...
					<div class="qnw-row">
						<div class="qnw-row-col">
							...
							<textarea name="postContent" id="postContent" class="qnw-ta"
					...
					<div class="qnw-btm">
						<button type="button" class="qnw-btn qnw-btn-cancel"
							id="qnaWriteCancelBtn">취소</button>

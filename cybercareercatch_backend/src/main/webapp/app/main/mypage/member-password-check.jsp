...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/main/mypage/member-password-check.css">
<script defer
		...
		<div class="main-container">
			...
			<div class="main-session">
				<form id="passwordCheckForm"
					action="${pageContext.request.contextPath}/member/mypage/checkPwOk.mpfc"
					method="post">

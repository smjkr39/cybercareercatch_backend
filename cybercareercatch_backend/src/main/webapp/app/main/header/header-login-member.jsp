...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/main/header/header-login-company.css" />
</head>
<body>
	<header class="header">
		<div class="header-inner">
			<h1 class="logo">
				<a href="${pageContext.request.contextPath}/mainpage/mainpage.mafc"
					class="logo-link" aria-label="CyberCareerCatch 홈"> <span
					...
					class="logo-strong">C</span><span class="logo-soft">atch</span>
				</a>
			</h1>
			...
			<nav class="main-nav" aria-label="메인 메뉴">
				<ul class="nav-list">
					<li class="nav-item dropdown"><a href="#" class="nav-link"
						onclick="toggleDropdown(event)">직군검사</a>
					...
					<li class="nav-item"><a
						...
						class="nav-link">기업홍보</a></li>

					<li class="nav-item dropdown"><a href="#" class="nav-link"
						onclick="toggleDropdown(event)">커뮤니티</a>
						<ul class="dropdown-menu">
							<li><a
								href="${pageContext.request.contextPath}/post/list.pfc">자유게시판</a></li>
							<li><a
								href="${pageContext.request.contextPath}/qna/list.qfc">기업QnA</a></li>
							<li><a href="/expo/calendar.efc">박람회일정</a></li>
						</ul></li>
				</ul>
			</nav>

			<div class="auth-area">
				<a href="${pageContext.request.contextPath}/member/mypage.mpfc"
					class="auth-btn auth-btn--member" aria-label="마이페이지로 이동"> <span
					class="member-name" id="headerMemberName">${sessionScope.userName}님</span>
            ...
            <path
				...
				</a> <a href="${pageContext.request.contextPath}/member/logoutOk.mefc"
					class="auth-btn auth-btn--logout">로그아웃</a>
			</div>
		</div>
	</header>
